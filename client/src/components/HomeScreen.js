...
const HomeScreen = () => {
    ...
    const menu = (
        ...
        >
            <MenuItem onClick={sortPublishNew}>Publish Date (Newest)</MenuItem>
    ...
    if (store) {
        workspace = 
            <div id="list-selector-list">
                <List sx={{ width: '90%', left: '5%' }} style ={{backgroundColor: "#ff8040"}}>
                {
    ...
    return (
        <div id="top5-list-selector">
           <div id="list-selector-heading">
               ...
               <IconButton disabled = {store.currentList} onClick = {handleCommunityList}>
                   <FunctionsIcon style ={{
                    fontSize: "30pt"
                }}/>
               </IconButton>
            ...
            <div id="list-selector-heading-right">
                <div id="list-selector-heading-sort">  
                    Sort By
                </div>
                <IconButton disabled = {store.currentList} onClick = {handleSortMenuOpen}>
                   <MenuIcon style ={{fontSize: "30pt"}}/>
               </IconButton>
